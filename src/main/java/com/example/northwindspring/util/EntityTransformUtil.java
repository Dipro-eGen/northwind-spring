...
public class EntityTransformUtil {
  ...
  /*public static <T> ValueTypeEnum getPropType(Field entityClazzField, Object o) {
    System.out.println(entityClazzField.getName());
    if (Objects.isNull(o)) {
    ...
    if (o instanceof Integer || o instanceof String || o instanceof Boolean ||
      o instanceof LocalDateTime || o instanceof LocalDate || o instanceof LocalTime || o instanceof Enum) {
      System.out.println("Integer String Boolean LocalDateTime LocalDate LocalTime");
      return ValueTypeEnum.ValueType;
    }
    ...
    System.out.println("other then Integer String or PersistentBag");
    return ValueTypeEnum.UnknownType;
  }*/
